...
add_action( 'init', 'pms_payment_gateways_webhook_catcher', 2 );
...
add_action( 'init', 'pms_payment_gateways_process_confirmation', 2 );
 ...
 * @param string $form_location   - where the request is coming from
 *
 * @return string
 *
 */
function pms_get_output_payment_gateways( $pms_settings = array(), $form_location = '' ) {
