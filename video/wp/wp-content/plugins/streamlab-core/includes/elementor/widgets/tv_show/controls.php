...
class Tv_Shows extends Widget_Base {
	public function get_name() {
		return __( 'Tv_Shows', 'streamlab-core' );
	}
	
	public function get_title() {
		return __( 'Tv Shows', 'streamlab-core' );
	}
	...
	protected function _register_controls()
	{
		...
		$this->start_controls_section(
			'section',
			[
				'label' => __( 'Tv Shows', 'streamlab-core' ),
			]
		);
		$this->add_control(
			'layout_style',
			[
				...
				'options' => [
					...
					'vertical-nav-slider'  => __( 'Vertical Slider', 'streamlab-core' ),
		...
		$this->add_control(
			'tv_show_box_style',
			[
				'label' => __( 'Tv Show Box Style', 'streamlab-core' ),
				'type' => Controls_Manager::SELECT,
				'multiple' => false,
				'default' => '1',
				'options' => [
		...
		$this->add_control(
			'post_ids',
			[
				'label' => __( 'Select Tv_Shows','streamlab-core' ),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'options' => $custom_post->get_custom_post('tv_show' ,  'id'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple' => true,
				'options' => $custom_post->get_taxonony('tv_show_genre'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple' => true,
				'options' => $custom_post->get_taxonony('tv_show_tag'),
        ...
        $this->start_controls_section(
			...
			[
				...
				'condition' => ['layout_style' => ['banner-slider' , 'vertical-nav-slider' , 'banner-slider-style-1' , 'banner-slider-style-3']]
			]
		);
        ...
        $this->start_controls_section(
			...
			[
				'label' => __( 'Button 2', 'hostingo-core' ),
	...
	protected function render() {
		...
		$args = $custom_post->build_args('tv_show' , $settings , array('post_genre' => 'tv_show_genre' ,  'post_tag' => 'tv_show_tag' ));
		...
		if($settings['layout_style'] == 'vertical-nav-horizontal-slider')
		{
			require plugin_dir_path( __FILE__ ) . 'nav-horizontal-slider.php';	
		}
...
Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Tv_Shows() );
