	...
	<div class="container-form">
			...
			<form class="form gentech-import" action="<?php echo esc_url( admin_url( 'admin.php?page=gentech-activate-theme-panel' ) ); ?>" method="post">
				<div class="help-description">
					<a href="https://developers.google.com/youtube/v3/getting-started" target="_blank"><?php esc_html_e('How to get API Key?', 'streamlab');?></a>
				</div>
				<div class="form-row">
					
					<div class="form-group">
						<label class="form-label" for="purchase_item"><?php esc_html_e( 'Enter Youtube Developer Api Key', 'streamlab' ); ?></label>
						<input class="form-control" placeholder="<?php esc_attr_e( 'Enter Youtube Developer Api Key', 'streamlab' ); ?>" type="text" name="api_key" data-type="youtube" value="<?php echo get_option( 'gen_youtube_api_key' ); ?>">
					</div>	
			...
			<div class="gen-data-wraper">
				<div class="form-row">
					...
					<div class="form-group">
						<a  class="button button-primary search-youtube" value="submit">
							<span class="gen-loading-icon dashicons dashicons-update"></span>
							<span class="text-btn"><?php esc_html_e( 'Search', 'streamlab' ); ?></span>
							
						</a>

						<a  class="button button-primary youtube-import" value="submit">
							<span class="gen-loading-icon dashicons dashicons-update"></span>
