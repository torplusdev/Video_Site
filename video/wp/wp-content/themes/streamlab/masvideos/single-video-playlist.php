<?php
/**
 * The Template for displaying all single video playlists
 *
 * This template can be overridden by copying it to yourtheme/masvideos/single-video-playlist.php.
 *
...
while ( have_posts() ) : the_post();
    ...
    get_template_part( 'template-parts/video/playlist/playlist', 'block');
