...
<div class="pms-form-fields">
    ...
    <div class="pms-form-field-wrapper">
        ...
        <p class="description"><?php printf( __( 'This option can be bypassed by adding the %s parameter to your login page URL: %s', 'paid-member-subscriptions' ), '<strong>pms_force_wp_login=true</strong>', '<a href="'.home_url( 'wp-login.php?pms_force_wp_login=true' ).'">'.home_url( 'wp-login.php?pms_force_wp_login=true' ).'</a>' ) ?></p>
    </div>
