...
if(!class_exists('Stremlab_Resize')) {
    class Aq_Exception extends Exception {}

    class Stremlab_Resize
    {
        /**
        ...
        /**
         * For your custom default usage you may want to initialize an Stremlab_Resize object by yourself and then have own defaults
         */
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                error_log('Stremlab_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('streamlab_resize')) {

    /**
     * This is just a tiny wrapper function for the class above so that there is no
     * need to change any code in your own WP themes. Usage is still the same :)
     */
    function streamlab_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $aq_resize = Stremlab_Resize::getInstance();
