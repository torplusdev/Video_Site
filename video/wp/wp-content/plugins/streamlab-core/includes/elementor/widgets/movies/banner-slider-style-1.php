			...
			while ($wp_query -> have_posts() ) 
			{
				...
				<div class="item" style="background: url('<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>')">
					<div class="gen-movie-contain-style-2 h-100">
									...
									<div class="gen-movie-meta-holder">
										...
										<div class="gen-meta-info">
											<ul class="gen-meta-after-excerpt">
												<li>
													<strong><?php echo esc_html($settings['cast_title']); ?></strong>	
													<?php
											...
											?>
												...
												<li>
													<strong><?php echo esc_html($settings['genre_title']); ?></strong>
						...
						<li>
													<strong><?php echo esc_html($settings['tag_title']); ?></strong>
